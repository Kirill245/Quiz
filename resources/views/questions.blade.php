        ...
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover table-bordered">
                ...
                <tr>
                        ...
                        <td>
                            <a href="#" class="text-warning" data-bs-toggle="modal" data-target="#Modal_update {{ $q->id }}">Update</a>
                            <a href="#" class="text-danger"  data-bs-toggle="tooltip" >Delete</a>
                        </td>
                    </tr>
    ...
    <form method="post" action="/update">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary">Update Question</button>
                ...
                <!-- Modal-Delete -->
<div class="modal fade" id="modal_delete{{ $q->id}}" tabindex="-1" role="dialog" aria-labelledby="modal_delete" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
    <form method="post" action="/delete">
            @csrf
      <div class="modal-header">
        <h5 class="modal-title" id="modal_delete">Delete</h5>
